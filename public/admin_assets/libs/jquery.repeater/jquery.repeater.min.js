            ...
            var s = function () {
                ...
                b.each(function (b) {
                    ...
                    e.data("item-name", c + "[" + b + "]"), l(e.find("[name]"), d).each(function () {
                        ...
                        f.attr("id", Eman), u(d, e, function (d) {
                            var e = a(this);
                            v(l(e.find("[data-repeater-item]"), d.repeaters || []), c + "_" + b + "_" + e.find("[data-repeater-list]").first().data("repeater-list") + "_", d.repeaters)
                        })
                    })
